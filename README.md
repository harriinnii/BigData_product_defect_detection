...
1. Producer sends screw inspection data to Kafka
2. Kafka streams data in real-time
3. Consumer reads data and stores into MongoDB
4. Spark performs analytics to detect defective screws
5. Python visualization generates charts
6. Real-time insights displayed using plots
